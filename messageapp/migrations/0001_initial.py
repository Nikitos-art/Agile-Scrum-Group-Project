    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='messageapp.chat', verbose_name='Чат')),
            ],
            options={
                'ordering': ['pub_date'],
            },
        ...
        migrations.AddField(
            model_name='chat',
            name='last_message',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='last_message', to='messageapp.message'),
        ),
        migrations.AddField(
            model_name='chat',
            name='members',
